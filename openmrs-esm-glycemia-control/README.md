# @openmrs/esm-glycemia-control

glycemia-control frontend module for O3
...
**http://localhost:8080/openmrs/spa/glycemia-control**
...
```bash
yarn add @openmrs/esm-glycemia-control
```
